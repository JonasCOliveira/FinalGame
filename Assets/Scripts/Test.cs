...
public class Test : MonoBehaviour
{
	...
	void Start()
	{
		...
		if(weightCounter >= 5)
        {
			GameHandler.weightOfElements[0] = 2.0; //spyke
			GameHandler.weightOfElements[1] = 1.0; //opossum
			GameHandler.weightOfElements[2] = 1.0; //eagle
			GameHandler.weightOfElements[3] = 1.0; //life
			GameHandler.weightOfElements[4] = 1.0; //frog
			
			GameHandler.FitnessValue = 50;
